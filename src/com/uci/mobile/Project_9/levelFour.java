...
//            		startActivity(intent);
        			AlertDialog.Builder dialog = new AlertDialog.Builder(levelFour.this);
    				dialog.setTitle("Congrats ");
    				dialog.setMessage("You Saved the World");
    				dialog.setPositiveButton("Restart Game", new DialogInterface.OnClickListener(){
    					public void onClick(DialogInterface dialog, int which) {
    						Intent intent = new Intent(levelFour.this,StoryMode.class);
    		        		startActivity(intent);
